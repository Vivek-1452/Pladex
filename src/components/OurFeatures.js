              ...
              >
                ...
                <div className="card-body">
                  ...
                  <p className="card-text my-4">
                    Students can easily <strong>explore</strong> more about
                    their dream colleges which helps them for their admission
                    process.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div className="card-body">
                  ...
                  <p className="card-text my-4">
                    ...
                    <strong>dream colleges</strong> based on your rank,
                    percentile and other details.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-6 mb-4">
              ...
              >
                ...
                <div className="card-body">
                  ...
                  <p className="card-text my-4">
                    Students can form <strong>network</strong> with peers of
                    same interests and also clarify their doubts in friendly
                    communities.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div className="card-body">
                  ...
                  <p className="card-text my-4">
                    ...
                    <strong> experiences</strong>, <strong>thoughts</strong>{" "}
                    with the Pladex community through your Blog.
                  </p>
                </div>
              </div>
            </div>
