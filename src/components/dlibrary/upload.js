    ...
    return (
        <div  style={{
         ...
         <div className="d-flex justify-content-center align-items-center py-5" >
            ...
            <div className="card mt-5 text-start" style={{
              // maxWidth: "50vw",
              width: display ? "100vw" : "60vw",
           ...
           <div className="row">
                  ...
                  <br></br>
                  <label className="pb-2">*link of website from where you got the book</label>
                      <input className="form-control "
                             type="text"
                             id='Booklink' name='Booklink'
                             autoComplete="off"
                             value={booklink}
                             onInput={e => setbooklink(e.target.value)}
                             style={{backgroundColor: '#C9EDDC', borderRadius: 15}}
                             required
                             autoFocus
                             />
                  ...
                  <button
                    type="submit"
                    className="btn bg-success mt-4 mb-2 col-md-6 text-white float-end me-3 w-100"
                  >
                    submit
                  </button>
                  </div>
